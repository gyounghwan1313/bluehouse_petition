...
### 데이터 불러오기
download.file("https://raw.githubusercontent.com/gyounghwan1313/bluehouse_petition/master/bluehouse_petition_data.csv",destfile = "./codeData.csv")
tab<-read.csv("./codeData.csv",stringsAsFactors = F,sep=',',fileEncoding = "EUC-KR")
...
# 긍정/부정 사전 불러오기
download.file("https://raw.githubusercontent.com/gyounghwan1313/bluehouse_petition/master/neg_pol_word.txt",destfile = "./codeData.txt")
neg=readLines('c:/data/neg_pol_word.txt',encoding='UTF-8')
download.file("https://raw.githubusercontent.com/gyounghwan1313/bluehouse_petition/master/pos_pol_word.txt",destfile = "./codeData.txt")
pos=readLines("./codeData.txt",encoding = "UTF-8")
